...
pytesseract.pytesseract.tesseract_cmd = config.get('Paths', 'tesseract_cmd')

# Path to the Poppler bin folder
poppler_path = config.get('Paths', 'poppler_path')

# Directory to monitor
monitor_directory_path = config.get('Paths', 'monitor_directory_path')
